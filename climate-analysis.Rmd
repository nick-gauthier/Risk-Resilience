...
# Introduction
In this two-part analysis we first compare temporal patterns of temperature and precipitation, derived from a transient paleoclimate simulation, at three points in the west Mediterranean. Then we analyze the spatial pattern of climate change from the LGM to the Mid Holocene using an ensemble of downscaled equilibrium paleoclimate simulations.
...
What about changes in spatial hetergeneity? First define a 5x5 weights matrix within which to sample the climate maps
```{r}
