...
```{r fig.fullwidth = TRUE, fig.width = 16.9, fig.height = 8.61, message = F}
...
## Trend Analysis
In the last plot, we calculated the "trend lines" using a simple scatterplot smoother. Let's use the **EMD** package to calculate actual trend lines using the empirical mode decomposition approach.
```{r cache = T}
