...
```{r trace_map, echo=FALSE, fig.show = 'hold', fig.cap = 'TraCE21-k global precipitation and temperature', fig.margin=TRUE, message=F, cache=TRUE}
...
```{r, echo=FALSE, fig.cap="Empirical mode decomposition", fig.height = 12, fig.margin=TRUE, message=F, cache=TRUE}
...
```{r bwplot, echo=FALSE, fig.cap="Black and white version", fig.width = 16.9, fig.height = 8.61, fig.margin=TRUE, message=F, cache=TRUE}
